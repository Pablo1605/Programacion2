    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (posicion < 0 || posicion >= valores.length) {
                throw new IllegalArgumentException("La posición introducida está fuera de rango");
            }
            ...
            System.out.println("Error: Debes introducir un número válido para la posición del array.");
